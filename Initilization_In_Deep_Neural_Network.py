# -*- coding: utf-8 -*-
"""
Created on Tue Jun 18 00:42:50 2019
...
from new_utils import sigmoid, relu, compute_loss, forward_propagation, backward_propagation
from new_utils import update_parameters, predict, load_dataset, plot_decision_boundary, predict_dec
...
def model(X, Y, learning_rate = 0.01, num_iterations = 1500000, print_cost = True, initialization = "he"):
    """
...
# GRADED FUNCTION: initialize_parameters_zeros '''# GRADED FUNCTION: initialize_parameters_zeros 
